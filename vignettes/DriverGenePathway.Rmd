...
driverGenes <- DriverGene(
  M,C,V,dict,chr_files_directory="chr_files_hg19",categ_flag=NaN, bmr=1.2e-6,
...
The DriverGenePathway package also provides a de novo method based on mutual exclusivity and coverage to search driver pathway. The only mandatory input of function `DriverPathway()` is mutation matrix that is a 0-1 mutation matrix where rows represent patients, columns represent genes as follows. 
